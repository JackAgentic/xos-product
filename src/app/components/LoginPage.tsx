...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(ellipse_1200px_1200px_at_top_left,_#2D6A4F_0%,_#081C15_45%,_#040E0A_100%)]">
      <motion.div
      ...
      >
        ...
        <div className="flex justify-center mb-10">
          <svg width="25" height="9" viewBox="0 0 25 9" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-10 w-auto">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-sm p-6">
          ...
          <p className="text-stone-400 text-sm mb-6">
            {isSignup ? 'Get started with XOS' : 'Welcome back to XOS'}
          </p>

          {error && (
            <div className="bg-red-500/10 border border-red-500/30 text-red-300 text-sm rounded-sm px-3 py-2 mb-4">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isSignup && (
              <div className="relative">
                ...
                <input
                  ...
                  required={isSignup}
                  className="w-full bg-white/5 border border-white/10 text-white placeholder-stone-500 rounded-sm pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-900 focus:border-transparent"
                />
              </div>
            )}
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-white/5 border border-white/10 text-white placeholder-stone-500 rounded-sm pl-10 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-900 focus:border-transparent"
              />
              <button
                type="button"
            ...
            <button
              ...
              className="w-full bg-emerald-800 hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-2.5 rounded-sm text-sm transition-colors flex items-center justify-center gap-2"
            >
