    ...
    >
      <div className="bg-white rounded-sm border border-gray-200 p-4 h-full flex flex-col">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-lg sm:text-2xl font-semibold">{selectedClient.name}</h1>
              ...
              <div className="flex items-center gap-2 flex-wrap mt-1">
                ...
                <span className="text-xs sm:text-sm text-gray-500">Client ID: #HC{String(selectedClient.id).padStart(3, '0')}</span>
              </div>
            </div>
          </div>
          <button 
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          ...
          <div className="bg-gray-50 rounded-sm p-4 mb-6 border border-gray-200 flex flex-col">
