...
export function NotesView({
  ...
  return (
    <div className="flex h-full overflow-hidden bg-gray-50 relative" data-ai-section="Notes">
      {/* Notes List */}
      <div className="w-full lg:w-[360px] bg-white border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-col h-full">
        ...
        {/* Empty State */}
        <div className="flex-1 overflow-y-auto" data-ai-section="Notes List">
      ...
      {/* Notes Detail */}
      <div className="flex-1 bg-gray-50 overflow-auto flex items-center justify-center pb-24" data-ai-section="Note Detail">
