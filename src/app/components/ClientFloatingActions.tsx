...
export function ClientFloatingActions({
    ...
    const { setActions, openAI } = useAIDrag();

    // Register these actions with the AI Provider
    useEffect(() => {
        setActions(
            <div className="flex items-center gap-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
                {/* Views Menu Button - Only on Overview */}
                {activeTab === 'overview' && (
                        ...
                        <Popover.Root open={isQuickActionsMenuOpen} onOpenChange={setIsQuickActionsMenuOpen}>
                            ...
                            <Popover.Portal>
                                ...
                                >
                                    ...
                                    <div className="py-2">
                                        <button onClick={() => { openAI(); setIsQuickActionsMenuOpen(false); }} className="w-full px-4 py-3 flex items-center gap-3 hover:bg-purple-50 transition-colors text-left font-medium text-purple-700">
