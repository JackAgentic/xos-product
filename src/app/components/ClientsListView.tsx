...
export function ClientsListView({
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="flex-1 flex flex-col overflow-hidden" data-ai-section="Clients List">
        {/* Header */}
        <div className="bg-white border-b border-gray-200 p-4 sm:p-4" data-ai-section="Client Filters">
        ...
        {/* Table */}
        <div className="flex-1 overflow-hidden bg-white flex flex-col" data-ai-section="Client Table">
          {/* Desktop Table View */}
