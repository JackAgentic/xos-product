                ...
                {dependentsData.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {dependentsData.map((dependent, index) => (
                      <div key={dependent.id} className="p-4 border border-gray-200 rounded-sm">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="space-y-3">
                        <label className="flex items-start gap-3 p-4 border border-gray-200 rounded-sm hover:bg-gray-50 cursor-pointer">
                          <input
                            type="checkbox"
